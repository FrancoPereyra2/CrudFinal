...
function ReadData() {
    ...
    listPeople.forEach(function (element, index) {
        ...
        html += '<td><div class="btn-container"><button onclick="deleteData(' + index + ')" class="btn btn-danger">Eliminar</button><button onclick="loadDataForEdit(' + index + ')" class="btn btn-warning">Editar</button></div></td>';
        html += "</tr>";
    });
